            ...
            <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {session?.user?.email === ADMIN_EMAIL && (
                        <button onClick={() => alert("Il pannello Admin è ora nella Dashboard.")} className="flex items-center gap-2 px-4 py-2 bg-amber-50 border border-amber-200 text-amber-600 rounded-2xl text-sm font-bold hover:bg-amber-100 transition-all"><Shield className="w-4 h-4" /> Admin</button>
                    )}
